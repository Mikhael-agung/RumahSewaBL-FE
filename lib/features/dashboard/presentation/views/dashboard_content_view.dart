...
class DashboardContentView extends StatelessWidget {
  ...
  const DashboardContentView({super.key, required this.username});
  ...
  List<Widget> _getMetricCards(
    ...
    final isLoading =
        tenantsController.isLoading.value ||
        propertiesController.isLoading.value;
    final totalActiveTenants = tenantsController.tenants.length;
    final occupiedRooms = propertiesController.rooms
        .where(_isRoomOccupied)
        .length;
    final availableRooms = propertiesController.rooms
  ...
  Widget _buildTunggakanItemMobile(
    String name,
    String initials,
    String room,
    String period,
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              onPressed: () {
                Get.snackbar(
                  "Informasi",
                  "Membuka seluruh riwayat pembayaran...",
                  snackPosition: SnackPosition.BOTTOM,
                );
              },
