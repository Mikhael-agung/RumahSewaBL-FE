class RouteName {
  ...
  static const String managerTenantsPage = '/manager/tenants';
  static const String managerPaymentsPage = '/manager/payments';
  static const String managerMaintenancePage = '/manager/maintenance';
  ...
  static const String adminMaintenancePage = '/admin/maintenance';
  static const String adminSettingsPage = '/admin/settings';
  static const String adminSupportPage = '/admin/support';
